...
void screen()
{
	...
	drawstring(210,425,0.0,"SRINIVAS INSTITUTE OF TECHNOLOGY MANGALURU VALACHILL",1);
	...
	drawstring(440,300,0.0,"AQUARIUM",1);
	  ...
	  drawstring(135,205,0.0,"STUDENT NAME",0);
	  	glColor3f(0.0,0.0,0.0);
	drawstring(140,170,0.0,"Andru Alwin Dsouza",0);
	drawstring(140,135,0.0,"Maruthi",0);
	drawstring(140,100,0.0,"G Harshith Rao",0);
		glColor3f(1.0,0.0,0.0);
	drawstring(710,205,0.0,"Under the Guidance of",0);
		glColor3f(0.0,0.0,0.0);
	drawstring(720,170,0.0,"Prof: ",0);
		glColor3f(1.0,1.0,0.0);
